...
PAGES = {
    ...
    "culture/musee-picasso-antibes/index.html": {
        ...
        "hours":"Depuis le 16 septembre : 10 h-12 h et 14 h-18 h, fermé le lundi. Plein tarif : 12 €.",
    ...
    "en/culture/picasso-museum-antibes/index.html": {
        ...
        "hours":"From 16 September: 10am-noon and 2pm-6pm, closed Monday. Full rate: €12.",
