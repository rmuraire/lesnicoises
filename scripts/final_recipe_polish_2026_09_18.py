...
def fix_home(rel: str, fr: bool) -> None:
    ...
    if fr:
        swaps = {
            '<li><a href="#planifier">Planifier</a></li>':'<li><a href="/riviera-chooser/">Planifier</a></li>',
        ...
        swaps = {
            '<li><a href="#plan">Plan</a></li>':'<li><a href="/en/riviera-chooser/">Plan</a></li>',
...
def validate() -> None:
    ...
    for marker in ('href="/en/riviera-chooser/">Plan</a>', 'href="/en/riviera-guide/">Places</a>', 'href="/stay/nice/">Stay</a>', 'href="/en/good-finds/">Now</a>'):
        if marker not in en_home: errors.append("EN home nav missing " + marker)
    for marker in ('href="/riviera-chooser/">Planifier</a>', 'href="/riviera-guide/">Lieux</a>', 'href="/fr/dormir/nice/">Dormir</a>', 'href="/bons-plans/">Maintenant</a>'):
