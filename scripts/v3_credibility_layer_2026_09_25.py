...
def patch_about(rel: str, lang: str) -> None:
    ...
    if lang == "fr":
        ...
        block = '''<section class="editor-identity" data-editor-identity="true"><span class="kicker">ÉDITEUR</span><h2>Créé et édité par Renaud Muraire.</h2><p>Niçois, Renaud a grandi avec la Côte d’Azur comme territoire familier, pas comme décor de brochure. Mametas combine cette connaissance personnelle avec un travail documenté sur les sources officielles, la géographie, les transports et les informations pratiques. Lorsqu’un lieu n’a pas été visité personnellement, le site ne prétend pas le contraire.</p><p><a href="/methode/">Lire la méthode Mametas Checked →</a> · <a href="/corrections/">Corrections & mises à jour →</a> · <a href="/presse/">Presse & professionnels →</a></p></section>'''
    else:
        anchor = '<h2>Where Mametas comes from</h2>'
        block = '''<section class="editor-identity" data-editor-identity="true"><span class="kicker">EDITOR</span><h2>Created and edited by Renaud Muraire.</h2><p>A Niçois, Renaud grew up with the French Riviera as familiar territory rather than brochure scenery. Mametas combines that personal knowledge with documented work on official sources, geography, transport and practical information. When somewhere has not been personally visited, the site does not pretend otherwise.</p><p><a href="/en/method/">Read the Mametas Checked method →</a> · <a href="/en/corrections/">Corrections & updates →</a> · <a href="/en/press/">Press & professionals →</a></p></section>'''
    if anchor in text:
