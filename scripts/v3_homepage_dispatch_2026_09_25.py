...
def home_experiences(lang: str) -> str:
    if lang == "fr":
        items = [
            ...
            ("/culture/fondation-maeght/", "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/08_Fondation_Maeght.JPG/960px-08_Fondation_Maeght.JPG", "ART", "Fondation Maeght", "L’une des meilleures raisons de quitter le littoral."),
        ...
        items = [
            ...
            ("/en/culture/fondation-maeght/", "https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/08_Fondation_Maeght.JPG/960px-08_Fondation_Maeght.JPG", "ART", "Fondation Maeght", "One of the best reasons to leave the coast."),
