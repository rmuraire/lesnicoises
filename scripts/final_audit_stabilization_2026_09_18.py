...
EXACT_REPLACEMENTS = {
    "index.html": (
        ('href="#plan">Plan</a>', 'href="/plan/">Plan</a>'),
        ('href="/en/riviera-chooser/">Plan</a>', 'href="/plan/">Plan</a>'),
        ('href="#places">Places</a>', 'href="/en/riviera-guide/">Places</a>'),
        ('href="#explore">Explore</a>', 'href="/en/explore/">Explore</a>'),
        ('href="#now">Now</a>', 'href="/en/practical/">Practical</a>'),
        ('/assets/v3.css?v=0.5', '/assets/v3.css?v=0.9'),
    ('/assets/v3.css?v=0.6', '/assets/v3.css?v=0.9'),
    ('/assets/v3.css?v=0.7', '/assets/v3.css?v=0.9'),
    ('/assets/v3.css?v=0.8', '/assets/v3.css?v=0.9'),
    ...
    "fr/index.html": (
        ('href="#planifier">Planifier</a>', 'href="/fr/planifier/">Plan</a>'),
        ('href="/riviera-chooser/">Planifier</a>', 'href="/fr/planifier/">Plan</a>'),
        ('href="#lieux">Lieux</a>', 'href="/riviera-guide/">Destinations</a>'),
        ('href="#explorer">Explorer</a>', 'href="/explore/">Explorer</a>'),
        ('href="#maintenant">Maintenant</a>', 'href="/pratique/">Pratique</a>'),
        ('/assets/v3.css?v=0.5', '/assets/v3.css?v=0.9'),
        ('<script src="/assets/v3.js"></script>', '<script src="/assets/v3.js?v=0.9"></script>'),
        ('<script src="/assets/v3.js?v=0.6"></script>', '<script src="/assets/v3.js?v=0.9"></script>'),
    ),
...
GLOBAL_HTML_REPLACEMENTS = (
    ...
    ('href="/#now">Now</a>', 'href="/en/practical/">Practical</a>'),
    ('href="#now">Now</a>', 'href="/en/practical/">Practical</a>'),
    ('href="/fr/#planifier">Planifier</a>', 'href="/fr/planifier/">Plan</a>'),
    ('href="#planifier">Planifier</a>', 'href="/fr/planifier/">Plan</a>'),
    ('href="#lieux">Lieux</a>', 'href="/riviera-guide/">Destinations</a>'),
    ...
    ('href="/restaurants/">Manger &amp; faire</a>', 'href="/explore/">Explorer</a>'),
    ('href="#maintenant">Maintenant</a>', 'href="/pratique/">Pratique</a>'),
    ('/assets/v3.css?v=0.4', '/assets/v3.css?v=0.9'),
    ('/assets/v3.css?v=0.5', '/assets/v3.css?v=0.9'),
    ('<script src="/assets/v3.js"></script>', '<script src="/assets/v3.js?v=0.9"></script>'),
    ('<script src="/assets/v3.js?v=0.6"></script>', '<script src="/assets/v3.js?v=0.9"></script>'),
    ('/assets/site.css?v=23.0', '/assets/site.css?v=24.1'),
...
"""
    ...
    checks = {
        ...
        "index.html": (
            ...
            'href="/en/practical/">Practical</a>',
            '/assets/v3.css?v=1.0',
            '/assets/v3.js?v=0.9',
        ),
        "fr/index.html": (
            'href="/fr/planifier/">Plan</a>',
            'href="/riviera-guide/">Destinations</a>',
            'href="/hotels/">Dormir</a>',
            'href="/explore/">Explorer</a>',
            'href="/pratique/">Pratique</a>',
            '/assets/v3.css?v=1.0',
            '/assets/v3.js?v=0.9',
        ),
        "assets/site.css": (
