...
HUB_LABEL_TO_SLUG = {
    ...
    'Toile Blanche': 'toile-blanche',
    'Hotel La Grande Bastide': 'la-grande-bastide',
    'Hôtel La Grande Bastide': 'la-grande-bastide',
    'Hôtel Les Messugues': 'hotel-les-messugues',
    'Hôtel Les Bastides Saint-Paul': 'les-bastides-saint-paul',
    'Hôtel Les Bastides Saint-Paul-de-Vence': 'les-bastides-saint-paul',
    'Hôtel Comté de Nice': 'hotel-comte-de-nice-beaulieu',
    'ibis Styles Beaulieu-sur-Mer': 'ibis-styles-beaulieu',
    'Hôtel Frisia': 'hotel-frisia',
    'Grand-Hôtel du Cap-Ferrat, A Four Seasons Hotel': 'grand-hotel-du-cap-ferrat',
    'Grand-Hotel du Cap-Ferrat, A Four Seasons Hotel': 'grand-hotel-du-cap-ferrat',
    'Hôtel Hermitage Monte-Carlo': 'hotel-hermitage-monte-carlo',
    'Monte-Carlo Bay Hotel & Resort': 'monte-carlo-bay',
    'Hôtel Victoria': 'hotel-victoria-roquebrune',
    'Ibis Roquebrune Cap Martin Menton': 'ibis-roquebrune-cap-martin',
    'ibis Roquebrune Cap Martin Menton': 'ibis-roquebrune-cap-martin',
    'Hôtel Belles Rives': 'hotel-belles-rives',
    'Hotel Juana': 'hotel-juana',
    'Hôtel le Sud': 'hotel-le-sud',
    'Hôtel Le Sud': 'hotel-le-sud',
    "Hôtel de L'Etoile": 'hotel-de-letoile-antibes',
    "Hôtel de l'Etoile": 'hotel-de-letoile-antibes',
    'Five Seas Hotel Cannes': 'five-seas-cannes',
    'Hotel Verlaine': 'hotel-verlaine-cannes',
    'Hôtel de Provence': 'hotel-de-provence-cannes',
    'Le Mas Candille': 'le-mas-candille',
    'Hôtel Villa Sophia': 'villa-sophia-mougins',
    'Kube Saint-Tropez Hôtel': 'kube-saint-tropez',
    'Kube Saint-Tropez Hotel': 'kube-saint-tropez',
    'Hôtel Villa Marie Saint-Tropez': 'villa-marie-saint-tropez',
    'Hotel Sezz Saint-tropez': 'sezz-saint-tropez',
    'Hotel Sezz Saint-Tropez': 'sezz-saint-tropez',
    'Hôtel La Ponche': 'la-ponche-saint-tropez',
    'Hôtel La Ponche · Saint Tropez': 'la-ponche-saint-tropez',
    'Hotel Les Palmiers': 'les-palmiers-sainte-maxime',
    'Hotel La Romarine': 'la-romarine',
    "Hôtel La Ferme d'Augustin": 'la-ferme-daugustin',
}
