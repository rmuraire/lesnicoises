...
def patch_finder(rel: str, lang: str) -> None:
    ...
    if lang == "fr":
        pairs = (
            ("<title>Trouver votre hôtel sur la Côte d’Azur | Mametas</title>",
             "<title>Mametas Hotel Fit : trouver l’hôtel qui colle à votre séjour</title>"),
            ...
            ('<p class="eyebrow">Le moteur hôtel Mametas</p>',
             '<p class="eyebrow">MAMETAS HOTEL FIT · LE MOTEUR HÔTEL</p>'),
        ...
        pairs = (
            ("<title>Find your French Riviera hotel | Mametas</title>",
             "<title>Mametas Hotel Fit: find the French Riviera hotel that fits</title>"),
            ...
            ('<p class="eyebrow">The Mametas hotel finder</p>',
             '<p class="eyebrow">MAMETAS HOTEL FIT · HOTEL TOOL</p>'),
    ...
    text = re.sub(r"/assets/hotel-engine\.js\?v=\d+", "/assets/hotel-engine.js?v=8", text)
...
def validate() -> None:
    ...
    for rel in ("hotels/finder/index.html", "en/hotels/finder/index.html"):
        ...
        if "/assets/hotel-engine.js?v=8" not in text:
            errors.append(f"{rel}: engine cache bust missing")

    hub_checks = {
        "hotels/index.html": ("MAMETAS HOTEL FIT · OUTIL INTERACTIF", "/lexique/#pichoun", "100 onglets d’hôtels", "EXEMPLE DE PRIORITÉS", "VOS PRIORITÉS", "RECOMMANDATION MAMETAS", "Hôtel La Pérouse", "Hôtel Apollinaire", "/assets/hotel-engine.css?v=10"),
        "en/hotels/index.html": ("MAMETAS HOTEL FIT · INTERACTIVE TOOL", "/en/lexicon/#pichoun", "opening 100 hotel tabs is not a strategy!", "EXAMPLE PRIORITIES", "YOUR PRIORITIES", "MAMETAS RECOMMENDATION", "Hôtel La Pérouse", "Hôtel Apollinaire", "/assets/hotel-engine.css?v=10"),
    }
