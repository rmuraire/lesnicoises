...
def validate() -> None:
    ...
    hub_checks = {
        "hotels/index.html": ("HOTEL FIT · OUTIL INTERACTIF MAMETAS", "/lexique/#pichoun", "100 onglets d’hôtels", "EXEMPLE DE PRIORITÉS", "VOS PRIORITÉS", "RECOMMANDATION MAMETAS", "Hôtel La Pérouse", "Hôtel Apollinaire", "/assets/hotel-engine.css?v=10"),
        "en/hotels/index.html": ("HOTEL FIT · MAMETAS INTERACTIVE TOOL", "/en/lexicon/#pichoun", "opening 100 hotel tabs is not a strategy!", "EXAMPLE PRIORITIES", "YOUR PRIORITIES", "MAMETAS RECOMMENDATION", "Hôtel La Pérouse", "Hôtel Apollinaire", "/assets/hotel-engine.css?v=10"),
    }
