...
HOTELS = [
    ...
    dict(slug="hotel-riva-art-and-spa", display="Hotel Riva Art & Spa", url="https://www.kqzyfj.com/click-101875476-15734754?url=https%3A%2F%2Fwww.booking.com%2FShare-uZRCL6", base="menton", fr_section="mer-calme", en_section="sea-quiet", fr_tag="Mer & spa", en_tag="Sea & spa", fr_copy="Face à la mer avec spa : pour ralentir sans renoncer à marcher vers le centre.", en_copy="Sea-facing with a spa: slow down without giving up the walk into central Menton.", image="/assets/hotels/v3/riva-art-spa/hero.jpg"),
    ...
    dict(slug="princess-et-richmond", display="Princess et Richmond", url="https://www.kqzyfj.com/click-101875476-15734754?url=https%3A%2F%2Fwww.booking.com%2FShare-iomATB", base="menton", fr_section="riviera-plus-chic", en_section="riviera-more-polished", fr_tag="Mer & plus chic", en_tag="Sea & more polished", fr_copy="Une option plus soignée face à la mer, sans quitter le rythme lent qui fait l’intérêt de Menton.", en_copy="A more polished sea-facing option without losing the slower rhythm that makes Menton worthwhile.", image="/assets/hotels/v3/princess-richmond/hero.jpg"),
